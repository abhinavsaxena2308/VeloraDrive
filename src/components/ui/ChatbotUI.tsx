  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-28 right-8 w-14 h-14 bg-cta rounded-full flex items-center justify-center text-white shadow-lg z-[999] hover:bg-red-700 transition-colors shadow-cta/30"
      >
          ...
          >
            ...
            <form onSubmit={handleSend} className="p-4 border-t border-white/5 flex gap-2">
              <input
                ...
                className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-xs focus:outline-none focus:border-cta text-white"
              />
              <button type="submit" className="w-10 h-10 bg-cta rounded-xl flex items-center justify-center text-white shrink-0 hover:bg-red-700 transition-colors">
                <Send size={18} />
              </button>
            </form>
          </motion.div>
