...
**Project:** VeloraDrive Eco
**Generated:** 2026-05-12 13:47:53
...
|------|-----|--------------|
| Primary | `#1F6F5F` | `--color-primary` |
| Secondary | `#2FA084` | `--color-secondary` |
| CTA/Accent | `#2FA084` | `--color-cta` |
| Background | `#EEEEEE` | `--color-background` |
| Text | `#1F6F5F` | `--color-text` |
